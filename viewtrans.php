...
<body>
  <section id="title" style="background-color:#2C2E43;">
    <div class="container-fluid">
      <nav class="navbar navbar-expand-lg navbar-light">
        <div class="container-fluid">
          <a class="navbar-brand" href="index.php" style="color: white;">PiratesBank</a>
      ...
      <table class="table table-hover" style="background-color: #B2B1B9;">
          <h2 class="text-center pt-4" style="font-weight:bold;background-color: #B2B1B9;">TRANSACTION HISTORY</h2>
      <thead>
        <tr>
