        ...
        $rows=mysqli_fetch_assoc($result);
          ...
          <div class="container-fluid">
            ...
            <table class="table table-hover">
                ...
                <tbody style="background-color:#787A91">
                    <tr>
          ...
          <footer class="page-footer font-small special-color-dark pt-4">
            ...
            <!-- Copyright -->
            <div class="footer-copyright text-center py-3" >For Illegal trading click here to become a premium member <br> Made for Pirates
            </div>
            <!-- Copyright -->
